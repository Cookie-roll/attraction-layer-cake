module.exports = {
    ...
    'attraction.g.description': 'Otwartx na romans, pewne rodzaje dotyku i głębokie więzi emocjonalne, ' +
                                'ale nie zainteresowanx związkami seksualnymi.',
    'attraction.o.name': 'Seksualność trzeciorzędna',
    'attraction.o.description': 'Nie odczuwa pociągu seksualnego, ale otwartx na stosunki seksaulne ' +
    ...
    'relationship.A.name': 'Ściśle monogamicznx',
    'relationship.A.description': 'Wchodzi w związki z jedną osobą na raz ' +
                                    'w celu zbudowania jednego związku na całe życie.',
    'relationship.B.name': 'Głównie monogamicznx',
    'relationship.B.description': 'Pragnie przede wszystkim związków monogamicznych, ' +
                                    'ale jest otwartx na poliamorię dla uszczęśliwienia partnerki/a ' +
                                    'lub z innych powodów.',
    'relationship.C.name': 'Bez preferencji',
    'relationship.C.description': 'Otwartx zarówno na poliamorię, jak i monogamię, indywidualnie dla każdego przypadku ' +
                                    'w zależności od pragnień zaangażowanych partnerów.',
    'relationship.D.name': 'Głównie poliamorycznx',
    'relationship.D.description': 'Pragnie przede wszystkim związków poliamorycznych, ' +
                                    'ale jest otwartx na monogamię dla uszczęśliwienia partnerki/a ' +
                                    'lub z innych powodów.',
    'relationship.E.name': 'Ściśle poliamorycznx',
    ...
    'orientation.0.name': 'Wyłącznie heteroseksualnx',
    'orientation.0.description': 'Zainteresowanx wyłącznie osobami odmiennej/ych płci.',
    'orientation.1.name': 'Głównie heteroseksualnx',
    'orientation.1.description': 'Zainteresowanx głównie osobami odmiennej/ych płci.',
    'orientation.2.name': 'Lekko heteroseksualnx',
    'orientation.2.description': 'Woli partnerki/ów odmiennej/ych płci, ' +
                                    'ale również zainteresowanx osobami tej samej płci.',
    'orientation.3.name': 'Biseksualnx / Panseksualnx',
    'orientation.3.description': 'Pociąg nie jest uzależniony od płci.',
    'orientation.4.name': 'Lekko homoseksualnx',
    'orientation.4.description': 'Woli partnerki/ów tej samej płci, ' +
                                    'ale również zainteresowanx osobami odmiennej/ych płci.',
    'orientation.5.name': 'Głównie homoseksualnx',
    'orientation.5.description': 'Zainteresowanx głównie osobami tej samej płci.',
    'orientation.6.name': 'Wyłącznie homoseksualnx',
    'orientation.6.description': 'Zainteresowanx wyłącznie osobami tej samej płci.',
    ...
    'privacy.noData': 'Wszystkie dane o opcjach, które zaznaczyłxś, są zakodowane w URL-u i nie są nigdzie zapisywane.',
    'privacy.tracking': 'Używam Plausible do analizy ruchu na stronie. Wszystkie dane odwiedzających są anonimizowane.',
    'privacy.contact': 'Jeśli masz pytania lub wnioski na temat Twoich danych osobowych, możesz skontaktować się ze mną przez ',
